...
import { performWhoisLookup, WhoisResult as WhoisResultType } from '../lib/whoisLookup';
            ...
            >
              ...
              <div className="space-y-6">
                <div className="bg-card border border-border rounded-lg p-6">
                  <h3 className="text-xl font-semibold mb-3">Domain Registration Information</h3>
                  <p className="text-muted-foreground">
                    WHOIS is a query and response protocol that provides information about domain registration, 
                    including the domain owner, registration and expiration dates, and name servers.
                  </p>
                </div>
                ...
                <div className="bg-card border border-border rounded-lg p-6">
                  ...
                  <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
                    ...
                    <li>Click the "Lookup WHOIS Information" button</li>
                    <li>View the detailed domain registration information</li>
                  </ol>
                </div>
                
                <div className="bg-card border border-border rounded-lg p-6">
                  <h3 className="text-xl font-semibold mb-3">Why Check WHOIS Information?</h3>
