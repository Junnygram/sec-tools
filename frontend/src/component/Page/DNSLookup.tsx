  ...
  return (
    <div className="h-screen flex flex-col bg-gradient-to-b from-background to-secondary/20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <motion.div
          className="absolute rounded-full bg-blue-500/5 w-96 h-96 top-1/4 -left-48"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.3, 0.5, 0.3],
          }}
              ...
              <div className="space-y-6">
                <div className="bg-card border border-border rounded-lg p-6">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    It translates human-readable domain names (like example.com)
                    to machine-readable IP addresses (like 192.0.2.1) that
                ...
                <div className="bg-card border border-border rounded-lg p-6">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                    <li>
                      <strong>A Record</strong>: Maps a domain to an IPv4
                      address
                    </li>
                    <li>
                      <strong>AAAA Record</strong>: Maps a domain to an IPv6
                      address
                    </li>
                    <li>
                      <strong>CNAME Record</strong>: Creates an alias pointing
                      to another domain
                    </li>
                    <li>
                      <strong>MX Record</strong>: Specifies mail servers for the
                      domain
                    </li>
                    <li>
                      <strong>TXT Record</strong>: Holds text information, often
                      used for verification
                    </li>
                    <li>
                      <strong>NS Record</strong>: Specifies the authoritative
